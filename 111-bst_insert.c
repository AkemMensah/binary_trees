...
/**
 * gt - Checks left ptrs to determine insert position
 * @new: Double ptr to new
 * @current: Double ptr to pointer to tree
 * @value: to insert
 *
 * Return: 1 on success, 0 on failure, 2 if duplicate found, 3 on malloc fail
 */
 ...
 * @tree: Double ptr to root node of BST to insert value
 * @value: Value to store the node being inserted
 *
 * Return: Ptr to node created, NULL on failure
